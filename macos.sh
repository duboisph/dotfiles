...
#sudo scutil --set ComputerName "Loki"
#sudo scutil --set HostName "Loki"
#sudo scutil --set LocalHostName "Loki"
#sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Loki"
...
# 1 or 25? - Hibernation (suspend to disk)
# 3 - Safe Sleep (suspend to RAM + disk, default)
...
# Install the Material Dark theme for iTerm
open "${HOME}/init/base16-material.dark.256.itermcolors"
